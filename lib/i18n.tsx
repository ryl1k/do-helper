...
const STRINGS = {
  uk: {
    ...
    "faq.source.crowdly": "Питання взяті з Crowdly — спільнотного банку тестів. Деякі можуть бути неточними або неправильними.",
    "faq.source.vns": "Також використано матеріали з VNS (системи дистанційного навчання університету).",
    "faq.source.disclaimer": "Якщо знайшов помилку — пиши, виправимо.",
    "faq.contribute.title": "Долучитися",
    "faq.contribute.body": "Проєкт відкритий. Зробити внесок:",
    "faq.contribute.repo": "github.com/ryl1k/do-helper",
    "faq.support.title": "Підтримка та зворотний зв'язок",
